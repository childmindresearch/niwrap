...
class SumaMakeSpecCaretOutputs(typing.NamedTuple):
    """
    Output object returned when calling `_suma_make_spec_caret(...)`.
    """
    root: OutputPathType
...
def _suma_make_spec_caret(
    ...
    Returns:
        NamedTuple of outputs (described in `SumaMakeSpecCaretOutputs`).
    """
    ...
    execution = runner.start_execution(_SUMA_MAKE_SPEC_CARET_METADATA)
    cargs = []
    cargs.append("@SUMA_Make_Spec_Caret")
    cargs.append("[OPTIONS]")
    cargs.append("-sid")
    cargs.extend(["-sid", subject_id])
    ret = SumaMakeSpecCaretOutputs(
...
__all__ = [
    "SumaMakeSpecCaretOutputs",
    "_SUMA_MAKE_SPEC_CARET_METADATA",
    "_suma_make_spec_caret",
]
