...
def adjunct_suma_fs_mask_and_qc(
    ...
    ret = AdjunctSumaFsMaskAndQcOutputs(
        ...
        fs_parc_wb_mask=execution.output_file(f"SUMA/fs_parc_wb_mask.nii.gz", optional=True),
        qc_image_00=execution.output_file(f"SUMA/qc_00*.jpg", optional=True),
        qc_image_01=execution.output_file(f"SUMA/qc_01*.jpg", optional=True),
        qc_image_02=execution.output_file(f"SUMA/qc_02*.jpg", optional=True),
        qc_image_03=execution.output_file(f"SUMA/qc_03*.jpg", optional=True),
        qc_image_04=execution.output_file(f"SUMA/qc_04*.jpg", optional=True),
        qc_image_05=execution.output_file(f"SUMA/qc_05*.jpg", optional=True),
    )
    execution.run(cargs)
    return ret
