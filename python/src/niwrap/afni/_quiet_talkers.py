...
class QuietTalkersOutputs(typing.NamedTuple):
    """
    Output object returned when calling `_quiet_talkers(...)`.
    """
    root: OutputPathType
