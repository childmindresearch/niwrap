...
class PythonModuleTestOutputs(typing.NamedTuple):
    """
    Output object returned when calling `python_module_test(...)`.
    """
    root: OutputPathType
    """Output root folder. This is the root folder for all outputs."""


def python_module_test(
    ...
    Returns:
        NamedTuple of outputs (described in `PythonModuleTestOutputs`).
    """
    runner = runner or get_global_runner()
    execution = runner.start_execution(PYTHON_MODULE_TEST_METADATA)
    cargs = []
    ...
    if test_modules is not None:
        cargs.extend(["-test_modules", *test_modules])
