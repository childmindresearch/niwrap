...
class MeasureErosionThickOutputs(typing.NamedTuple):
    """
    Output object returned when calling `_measure_erosion_thick(...)`.
    """
    root: OutputPathType
...
def _measure_erosion_thick(
    ...
    Returns:
        NamedTuple of outputs (described in `MeasureErosionThickOutputs`).
    """
    runner = runner or get_global_runner()
    execution = runner.start_execution(_MEASURE_EROSION_THICK_METADATA)
    cargs = []
    ...
    ret = MeasureErosionThickOutputs(
...
__all__ = [
    "MeasureErosionThickOutputs",
    "_MEASURE_EROSION_THICK_METADATA",
    "_measure_erosion_thick",
]
