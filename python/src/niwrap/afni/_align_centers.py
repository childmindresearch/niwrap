...
class AlignCentersOutputs(typing.NamedTuple):
    """
    Output object returned when calling `_align_centers(...)`.
    """
    root: OutputPathType
...
def _align_centers(
    ...
    Returns:
        NamedTuple of outputs (described in `AlignCentersOutputs`).
    """
    runner = runner or get_global_runner()
    execution = runner.start_execution(_ALIGN_CENTERS_METADATA)
    cargs = []
