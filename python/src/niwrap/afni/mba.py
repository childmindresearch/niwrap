...
def mba(
    ...
    ret = MbaOutputs(
        ...
        output_txt=execution.output_file(f"{prefix}.txt", optional=True),
        output_rdata=execution.output_file(f"{prefix}.RData", optional=True),
        matrix_plot=execution.output_file(f"{prefix}_matrixplot.png", optional=True),
    )
    execution.run(cargs)
    return ret
