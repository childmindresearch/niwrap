...
def fat_proc_dwi_to_dt(
    ...
    qc_fa_thr: float | int | None = None,
    qc_fa_max: float | int | None = None,
    qc_fa_unc_max: float | int | None = None,
    qc_v12_unc_max: float | int | None = None,
    ...
    uncert_iters: float | int | None = None,
    ...
    cargs.extend(["-in_col_matA | -in_col_matT | -in_col_vec | -in_row_vec", execution.input_file(in_gradmat)])
    cargs.append("-prefix")
