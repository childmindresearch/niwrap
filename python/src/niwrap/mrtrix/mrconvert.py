...
def mrconvert(
    ...
    """
    mrconvert by J-Donald Tournier (jdtournier@gmail.com) and Robert E. Smith
    ...
    ret = MrconvertOutputs(
        ...
        coord=[coord.outputs(execution) for coord in coord],
        clear_property=[clear_property.outputs(execution) for clear_property in clear_property],
        set_property=[set_property.outputs(execution) for set_property in set_property],
        append_property=[append_property.outputs(execution) for append_property in append_property],
        fslgrad=fslgrad.outputs(execution),
        export_grad_fsl=export_grad_fsl.outputs(execution),
        import_pe_eddy=import_pe_eddy.outputs(execution),
