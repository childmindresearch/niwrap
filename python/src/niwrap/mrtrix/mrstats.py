...
class Output:
    ...
    deviation. For complex data, min, max and std are calculated separately for
    real and imaginary parts, std_rv is based on the real valued variance
...
def mrstats(
    ...
    More information:
    https://mrtrix.readthedocs.io/en/latest/reference/commands/mrstats.html
    ...
    ret = MrstatsOutputs(
        root=execution.output_file("."),
        output=[output.outputs(execution) for output in output],
