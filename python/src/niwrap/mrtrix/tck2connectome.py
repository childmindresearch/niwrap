...
TCK2CONNECTOME_METADATA = Metadata(
    id="97944cceff50364b7f1df2a017a5e6a8f41c89a5",
    name="tck2connectome",
...
def tck2connectome(
    ...
    ret = Tck2connectomeOutputs(
        ...
        out_assignments=execution.output_file(f"{pathlib.Path(out_assignments).stem}") if out_assignments is not None else None,
    )
    execution.run(cargs)
    return ret
