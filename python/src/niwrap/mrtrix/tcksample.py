...
class TcksampleConfigOutputs(typing.NamedTuple):
    """
    Output object returned when calling `TcksampleConfig.run(...)`.
    """
    root: OutputPathType
...
class TcksampleConfig:
    ...
    def outputs(
        ...
        Args:
            ...
            execution: The execution object.
        Returns:
            NamedTuple of outputs (described in `TcksampleConfigOutputs`).
        """
        ret = TcksampleConfigOutputs(
...
class TcksampleOutputs(typing.NamedTuple):
    ...
    config: typing.List[TcksampleConfigOutputs]
    """Subcommand outputs"""
