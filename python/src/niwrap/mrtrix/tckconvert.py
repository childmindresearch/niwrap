...
class TckconvertConfigOutputs(typing.NamedTuple):
    """
    Output object returned when calling `TckconvertConfig.run(...)`.
    """
    root: OutputPathType
...
class TckconvertConfig:
    ...
    def outputs(
        ...
        Args:
            ...
            execution: The execution object.
        Returns:
            NamedTuple of outputs (described in `TckconvertConfigOutputs`).
        """
        ret = TckconvertConfigOutputs(
...
class TckconvertOutputs(typing.NamedTuple):
    ...
    config: typing.List[TckconvertConfigOutputs]
    """Subcommand outputs"""
...
def tckconvert(
    ...
    if scanner2voxel is not None:
        cargs.extend(["-scanner2voxel", execution.input_file(scanner2voxel)])
    if scanner2image is not None:
        cargs.extend(["-scanner2image", execution.input_file(scanner2image)])
    if voxel2scanner is not None:
        cargs.extend(["-voxel2scanner", execution.input_file(voxel2scanner)])
    if image2scanner is not None:
        cargs.extend(["-image2scanner", execution.input_file(image2scanner)])
    if sides is not None:
        cargs.extend(["-sides", str(sides)])
