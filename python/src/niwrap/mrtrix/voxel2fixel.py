...
VOXEL2FIXEL_METADATA = Metadata(
    id="d4c5ee7e22d647f7594fc5dc9c647ca7d06a36cb",
    name="voxel2fixel",
...
def voxel2fixel(
    ...
    cargs.extend(["", execution.input_file(image_in)])
    cargs.extend(["", execution.input_file(fixel_directory_in)])
    cargs.extend(["", fixel_directory_out])
