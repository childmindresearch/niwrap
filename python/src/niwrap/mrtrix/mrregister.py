...
def mrregister(
    ...
    rigid_scale: list[float | int] | None = None,
    ...
    affine_scale: list[float | int] | None = None,
    ...
    init_rotation_search_angles: list[float | int] | None = None,
    ...
    nl_scale: list[float | int] | None = None,
    ...
    mc_weights: list[float | int] | None = None,
