...
class MrdumpConfigOutputs(typing.NamedTuple):
    """
    Output object returned when calling `MrdumpConfig.run(...)`.
    """
    root: OutputPathType
...
class MrdumpConfig:
    ...
    def outputs(
        ...
        Args:
            ...
            execution: The execution object.
        Returns:
            NamedTuple of outputs (described in `MrdumpConfigOutputs`).
        """
        ret = MrdumpConfigOutputs(
...
class MrdumpOutputs(typing.NamedTuple):
    ...
    config: typing.List[MrdumpConfigOutputs]
    """Subcommand outputs"""
