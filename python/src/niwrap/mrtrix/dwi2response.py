...
class Dwi2responseDhollanderOutputs(typing.NamedTuple):
    """
    Output object returned when calling `Dwi2responseDhollander.run(...)`.
    """
    root: OutputPathType
...
This is an improved version of the Dhollander et al. (2016) algorithm for unsupervised estimation of WM, GM and CSF response functions, which includes the Dhollander et al. (2019) improvements for single-fibre WM response function estimation (prior to this update, the "dwi2response tournier" algorithm had been utilised specifically for the single-fibre WM response function estimation step).
    ...
    def run(
        ...
        if self.erode is not None:
            cargs.extend(["-erode", str(self.erode)])
        if self.fa is not None:
            cargs.extend(["-fa", str(self.fa)])
        if self.sfwm is not None:
            cargs.extend(["-sfwm", str(self.sfwm)])
        if self.gm is not None:
            cargs.extend(["-gm", str(self.gm)])
        if self.csf is not None:
            cargs.extend(["-csf", str(self.csf)])
        if self.wm_algo is not None:
            cargs.extend(["-wm_algo", self.wm_algo])
        return cargs
    ...
    def outputs(
        ...
        ret = Dwi2responseDhollanderOutputs(
            ...
            out_sfwm=execution.output_file(f"{self.out_sfwm}"),
            out_gm=execution.output_file(f"{self.out_gm}"),
            out_csf=execution.output_file(f"{self.out_csf}"),
        )
        return ret
...
class Dwi2responseFaOutputs(typing.NamedTuple):
    """
    Output object returned when calling `Dwi2responseFa.run(...)`.
    """
    root: OutputPathType
    """Output root folder. This is the root folder for all outputs."""
...
class Dwi2responseFa:
    ...
    def run(
        ...
        if self.number is not None:
            cargs.extend(["-number", str(self.number)])
        if self.threshold is not None:
            cargs.extend(["-threshold", str(self.threshold)])
        return cargs
...
class Dwi2responseManualOutputs(typing.NamedTuple):
    """
    Output object returned when calling `Dwi2responseManual.run(...)`.
    """
    root: OutputPathType
    """Output root folder. This is the root folder for all outputs."""
    output_: OutputPathType
...
class Dwi2responseManual:
    ...
    def run(
        ...
        if self.dirs is not None:
            cargs.extend(["-dirs", execution.input_file(self.dirs)])
        return cargs
    ...
    def outputs(
        ...
        ret = Dwi2responseManualOutputs(
            root=execution.output_file("."),
            output_=execution.output_file(f"{self.output}"),
        )
        return ret
...
class Dwi2responseMsmt5ttOutputs(typing.NamedTuple):
    """
    Output object returned when calling `Dwi2responseMsmt5tt.run(...)`.
    """
    root: OutputPathType
    """Output root folder. This is the root folder for all outputs."""
    out_wm: OutputPathType
    """Output WM response text file"""
    out_gm_: OutputPathType
    """Output GM response text file"""
    out_csf_: OutputPathType
...
class Dwi2responseMsmt5tt:
    ...
    sfwm_fa_threshold: float | int | None = None
    ...
    def run(
        ...
        if self.pvf is not None:
            cargs.extend(["-pvf", str(self.pvf)])
        if self.wm_algo is not None:
            cargs.extend(["-wm_algo", self.wm_algo])
        if self.sfwm_fa_threshold is not None:
            cargs.extend(["-sfwm_fa_threshold", str(self.sfwm_fa_threshold)])
        return cargs
    ...
    def outputs(
        ...
        ret = Dwi2responseMsmt5ttOutputs(
            root=execution.output_file("."),
            out_wm=execution.output_file(f"{self.out_wm}"),
            out_gm_=execution.output_file(f"{self.out_gm}"),
            out_csf_=execution.output_file(f"{self.out_csf}"),
        )
        return ret
...
class Dwi2responseTaxOutputs(typing.NamedTuple):
    """
    Output object returned when calling `Dwi2responseTax.run(...)`.
    """
    root: OutputPathType
    """Output root folder. This is the root folder for all outputs."""
    output_2: OutputPathType
    """The output response function text file"""
...
class Dwi2responseTax:
    ...
    output: str
    """The output response function text file"""
    peak_ratio: float | int | None = None
    """Second-to-first-peak amplitude ratio threshold"""
    max_iters: int | None = None
    """Maximum number of iterations"""
    convergence: float | int | None = None
    ...
    def run(
        ...
        if self.peak_ratio is not None:
            cargs.extend(["-peak_ratio", str(self.peak_ratio)])
        if self.max_iters is not None:
            cargs.extend(["-max_iters", str(self.max_iters)])
        if self.convergence is not None:
            cargs.extend(["-convergence", str(self.convergence)])
        return cargs
    ...
    def outputs(
        ...
        ret = Dwi2responseTaxOutputs(
            root=execution.output_file("."),
            output_2=execution.output_file(f"{self.output}"),
        )
        return ret
...
class Dwi2responseTournierOutputs(typing.NamedTuple):
    """
    Output object returned when calling `Dwi2responseTournier.run(...)`.
    """
    root: OutputPathType
    """Output root folder. This is the root folder for all outputs."""
    output_3: OutputPathType
    """The output response function text file"""
...
class Dwi2responseTournier:
    ...
    def run(
        ...
        if self.iter_voxels is not None:
            cargs.extend(["-iter_voxels", str(self.iter_voxels)])
        if self.dilate is not None:
            cargs.extend(["-dilate", str(self.dilate)])
        if self.max_iters is not None:
            cargs.extend(["-max_iters", str(self.max_iters)])
        return cargs
    ...
    def outputs(
        ...
        ret = Dwi2responseTournierOutputs(
            root=execution.output_file("."),
            output_3=execution.output_file(f"{self.output}"),
        )
        return ret
...
def dwi2response(
    ...
    if scratch is not None:
        cargs.extend(["-scratch", scratch])
    if continue_ is not None:
        cargs.extend(["-continue", continue_])
    if info:
        cargs.append("-info")
    if quiet:
        cargs.append("-quiet")
