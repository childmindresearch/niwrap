...
class MaskfilterConfigOutputs(typing.NamedTuple):
    """
    Output object returned when calling `MaskfilterConfig.run(...)`.
    """
    root: OutputPathType
...
class MaskfilterConfig:
    ...
    def outputs(
        ...
        Args:
            ...
            execution: The execution object.
        Returns:
            NamedTuple of outputs (described in `MaskfilterConfigOutputs`).
        """
        ret = MaskfilterConfigOutputs(
...
class MaskfilterOutputs(typing.NamedTuple):
    ...
    """the output image."""
    config: typing.List[MaskfilterConfigOutputs]
    """Subcommand outputs"""
...
def maskfilter(
    ...
    config: list[MaskfilterConfig] = None,
    help_: bool = False,
    version: bool = False,
    runner: Runner = None,
) -> MaskfilterOutputs:
    """
    maskfilter by Robert E. Smith (robert.smith@florey.edu.au), David Raffelt
    (david.raffelt@florey.edu.au), Thijs Dhollander (thijs.dhollander@gmail.com) and
