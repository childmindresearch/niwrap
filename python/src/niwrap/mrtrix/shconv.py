...
SHCONV_METADATA = Metadata(
    id="bc99c293070cab736d7d62ed5beb438cbce6ffe4",
    name="shconv",
...
def shconv(
    ...
    """
    shconv by David Raffelt (david.raffelt@florey.edu.au) and J-Donald Tournier
    ...
    More information:
    https://mrtrix.readthedocs.io/en/latest/reference/commands/shconv.html
