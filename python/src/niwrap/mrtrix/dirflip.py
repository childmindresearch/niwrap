...
class DirflipConfigOutputs(typing.NamedTuple):
    """
    Output object returned when calling `DirflipConfig.run(...)`.
    """
    root: OutputPathType
...
class DirflipConfig:
    ...
    def outputs(
        ...
        Args:
            ...
            execution: The execution object.
        Returns:
            NamedTuple of outputs (described in `DirflipConfigOutputs`).
        """
        ret = DirflipConfigOutputs(
...
class DirflipOutputs(typing.NamedTuple):
    ...
    config: typing.List[DirflipConfigOutputs]
    """Subcommand outputs"""
