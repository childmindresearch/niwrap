...
def mrgrid(
    ...
    """
    mrgrid by Max Pietsch (maximilian.pietsch@kcl.ac.uk) & David Raffelt
    ...
    More information:
    https://mrtrix.readthedocs.io/en/latest/reference/commands/mrgrid.html
    ...
    if uniform is not None:
        cargs.extend(["-uniform", str(uniform)])
    if mask is not None:
    ...
    ret = MrgridOutputs(
        ...
        axis=[axis.outputs(execution) for axis in axis],
