...
class WarpinvertConfigOutputs(typing.NamedTuple):
    """
    Output object returned when calling `WarpinvertConfig.run(...)`.
    """
    root: OutputPathType
...
class WarpinvertConfig:
    ...
    def outputs(
        ...
        Args:
            ...
            execution: The execution object.
        Returns:
            NamedTuple of outputs (described in `WarpinvertConfigOutputs`).
        """
        ret = WarpinvertConfigOutputs(
...
class WarpinvertOutputs(typing.NamedTuple):
    ...
    config: typing.List[WarpinvertConfigOutputs]
    """Subcommand outputs"""
...
def warpinvert(
    ...
    config: list[WarpinvertConfig] = None,
    help_: bool = False,
    version: bool = False,
    runner: Runner = None,
) -> WarpinvertOutputs:
