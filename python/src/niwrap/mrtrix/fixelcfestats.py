...
def fixelcfestats(
    ...
    cfe_dh: float | int | None = None,
    cfe_e: float | int | None = None,
    cfe_h: float | int | None = None,
    cfe_c: float | int | None = None,
    ...
    * If using the -nonstationary option:
    ...
    if cfe_dh is not None:
        cargs.extend(["-cfe_dh", str(cfe_dh)])
    if cfe_e is not None:
        cargs.extend(["-cfe_e", str(cfe_e)])
    if cfe_h is not None:
        cargs.extend(["-cfe_h", str(cfe_h)])
    if cfe_c is not None:
        cargs.extend(["-cfe_c", str(cfe_c)])
    if cfe_legacy:
