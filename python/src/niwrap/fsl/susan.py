...
SUSAN_METADATA = Metadata(
    id="ad5574f1e66f3d05f161d3fc757790b7cac29eb9",
    name="susan",
...
def susan(
    ...
    brightness_threshold: float | int,
    spatial_size: float | int,
    dimensionality: float | int,
    use_median_filter: float | int,
    n_usans: float | int,
    output_file: str,
    ...
    ret = SusanOutputs(
        ...
        filtered_output=execution.output_file(f"{output_file}"),
    )
    execution.run(cargs)
    return ret
