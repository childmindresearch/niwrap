...
def bedpostx_gpu(
    ...
    num_fibers: float | int | None = None,
    ard_weight: float | int | None = None,
    burnin_period: float | int | None = None,
