...
def fabber_dualecho(
    ...
    ret = FabberDualechoOutputs(
        ...
        output_files=execution.output_file(f"{output_directory}/*", optional=True),
    )
    execution.run(cargs)
    return ret
