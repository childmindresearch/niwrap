...
def fabber_asl(
    ...
    More information: https://fabber_tool.website
    ...
    ret = FabberAslOutputs(
        ...
        logfile=execution.output_file(f"{output}/logfile.txt"),
        modelfit=execution.output_file(f"{output}/model_fit.nii.gz", optional=True),
        residuals=execution.output_file(f"{output}/residuals.nii.gz", optional=True),
        model_extras=execution.output_file(f"{output}/extras.nii.gz", optional=True),
        mvn=execution.output_file(f"{output}/mvn.nii.gz", optional=True),
        means=execution.output_file(f"{output}/means.nii.gz", optional=True),
        stds=execution.output_file(f"{output}/stds.nii.gz", optional=True),
        variances=execution.output_file(f"{output}/variances.nii.gz", optional=True),
        zstats=execution.output_file(f"{output}/zstats.nii.gz", optional=True),
