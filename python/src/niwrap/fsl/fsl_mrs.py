...
FSL_MRS_METADATA = Metadata(
    id="0919d61b8d24d8c17adb6082560ac236036570c3",
    name="fsl_mrs",
...
def fsl_mrs(
    ...
    """
    fsl_mrs by FMRIB Centre, University of Oxford.
    ...
    if h2o_file is not None:
        cargs.extend(["--h2o", execution.input_file(h2o_file)])
