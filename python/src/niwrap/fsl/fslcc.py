...
FSLCC_METADATA = Metadata(
    id="16ef9b67282ac745bef8c8cfd9a3807c9bd0d92f",
    name="fslcc",
...
def fslcc(
    ...
    threshold: float | int | None = 0.1,
    decimal_places: float | int | None = 2,
    runner: Runner = None,
) -> FslccOutputs:
    """
    fslcc by Oxford Centre for Functional MRI of the Brain (FMRIB).
    ...
    if threshold is not None:
        cargs.extend(["-t", str(threshold)])
    if decimal_places is not None:
        cargs.extend(["-p", str(decimal_places)])
    ret = FslccOutputs(
