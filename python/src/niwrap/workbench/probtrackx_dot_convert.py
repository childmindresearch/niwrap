...
def probtrackx_dot_convert(
    ...
    ret = ProbtrackxDotConvertOutputs(
        ...
        row_voxels=row_voxels.outputs(execution),
        row_cifti=row_cifti.outputs(execution),
        col_voxels=col_voxels.outputs(execution),
        col_cifti=col_cifti.outputs(execution),
    )
    execution.run(cargs)
    return ret
